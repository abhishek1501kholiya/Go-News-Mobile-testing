class Form {
  ...
  //  console.log(fName);
      ...
      this.didyouknow.position(50,525);
      this.Explore.position(250,525);
      this.UploadPost.position(500,525);
      this.ViewPosts.position(800,525);
      this.feedback.position(1050,525);
      this.more.position(1300,525);
      fill('Black');
      if(gameState === "Home"){
      //  rect(20,705,850,100);
      }
